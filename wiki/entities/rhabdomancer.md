...
Complements decompiled-pseudocode SAST via [[ida-security-scanner]] and sits in the same headless idalib automation lane as [[headless-ida]], [[ida-cli]], and [[ida-buddy]] when hunting risky native calls in game clients, anti-cheat drivers, and protected binaries.
...
[[overviews/reverse-engineering]] · [[ida-security-scanner]] · [[headless-ida]] · [[ioctlpus]] · [[driver-vuln-analyzer-ida-plugin]] · [[list-of-ida-plugins]]
