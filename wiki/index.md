...
- [DMA Attack](overviews/dma-attack.md) — PCIe DMA threat model (cheat PC + FPGA + HID); three defense layers; firmware tiers 0–6; layered detection + TPM attestation; Cheat (~2788) / Detection:DMA (~708) + [[aetheris]]/[[luminary-dma]] MemProcFS forensics + WSF ~10 [[windows-runtime-attestation-report]]
